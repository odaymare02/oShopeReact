...
export default function Register() {
  ...
  return (
    <section className='register'>
      <div className="title text-center" data-aos="fade-right" data-aos-duration="1500" >
        Register page
      </div>
      <div className="row d-flex justify-content-center align-items-center vh-100" >
        ...
        <div className="col-md-8 d-flex justify-content-center align-items-center" data-aos="fade-up" data-aos-duration="2500">
          ...
          <div className={`${style.loginTitle} mb-5 text-center`}>
            ...
            <div>
              ...
              <div className="buttons d-flex flex-column gap-3">
                <button className={`btn text-center bg-dark text-light w-100 ${style.loginbtn}`} type='submit'>
                {
              ...
              <span  > 
                ...
                <Link className={`${style.LinkDec}`} to={"/login"}> Login</Link>
                </span>
              </span>
              </div>
            </div>
