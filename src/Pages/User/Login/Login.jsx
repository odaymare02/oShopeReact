...
export default function Login() {
  ...
  return (
    <section className='login'>
      <div className="title text-center mb-5" data-aos="fade-right" data-aos-duration="1500" >
        Login Page
      </div>
      <div className="row d-flex justify-content-center align-items-center" >
        ...
        <div className="col-md-6 d-flex justify-content-center align-items-center"  data-aos="fade-down" data-aos-duration="2500">
          ...
          <div className={`${style.loginTitle} mb-5 text-center`}>
            ...
            <div>
              ...
              <button className="btn text-center btn-outline-info w-100" > 
                <Link className={`${style.LinkDec}`} to={"/register"}>   Register Now</Link>
              </button>
              <Link className={`align-self-end ${style.forgetPass}`} to={"/sendcode"}>
                Forget Password ?
              </Link>
              </div>
            </div>
